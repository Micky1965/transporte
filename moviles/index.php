            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-outline card-secondary">
                        <!-- Aqui se creó un LINK en el título para redireccionar a un archivo de reportes
                        que esta listo para imprimir o pasar los datos a .exe -->
                        <div class="card-header">
                            <h3 class="card-title"><a href="../reportes/movileslist.php" class="link"><b>Guardar Listado de Vehículos</b></a></h3>
                        </div>
