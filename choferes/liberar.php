...
$sentencia = $pdo->prepare("UPDATE tb_choferes SET nombre_chofer=:nombre_chofer, 
                            dni_chofer=:dni_chofer, estado=:estado WHERE nombre_chofer=:nombre_chofer");
...
if($sentencia->execute()){
    session_start();
    $_SESSION['mensaje'] = "El Chofer Queda Libre";
